...
public class Tarmac_1_2_Ball_2 extends SequentialCommandGroup {

    public Tarmac_1_2_Ball_2(DriveTrain driveTrain, Indexer indexer, IndexerLifter indexerLifter) {
        addCommands(new AutoLiftDown(indexerLifter));
        addCommands(new AutoIndexDrive(driveTrain, indexer, "src\\main\\java\\frc\robot\\Autos\\Trajectorial\\Routes\\output\\2BallAuto2.wpilib.json"));
