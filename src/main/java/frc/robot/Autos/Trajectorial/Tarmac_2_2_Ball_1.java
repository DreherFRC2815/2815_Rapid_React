...
public class Tarmac_2_2_Ball_1 extends SequentialCommandGroup {

    public Tarmac_2_2_Ball_1(DriveTrain driveTrain, Indexer indexer, IndexerLifter indexerLifter) {
        addCommands(new AutoLiftDown(indexerLifter));
        addCommands(new AutoIndexDrive(driveTrain, indexer, "src\\main\\java\\frc\robot\\Autos\\Trajectorial\\Routes\\output\\2BallAuto3.wpilib.json"));
